...
class OphMiMinoropschecklistModule extends BaseEventTypeModule
{
	...
	public function init()
	{
		...
		$this->setImport(array(
			'OphMiMinoropschecklist.models.*',
			'OphMiMinoropschecklist.components.*',
		));

		$this->moduleShortSuffix = "minoropschecklist";
	}
